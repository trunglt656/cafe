    ...
    public class HoaDonBLL
    {
        ...
        public string MaHDChuaTT(string maBan)
        {
            try
            {
                if (dbs == null)
                {
                    throw new NullReferenceException("Đối tượng dbs chưa được khởi tạo.");
                }

                object result = dbs.MyExecuteScalar("USP_LayMaHDChuaTT", CommandType.StoredProcedure, new SqlParameter("@maBan", maBan));
